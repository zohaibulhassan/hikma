...
@section('content')
    ...
    <div class="card">
        <div class="row">
            ...
            <div class="card-header col-4" style="border-bottom: 0px">
                <select class="form-select form-control" onchange="location = this.value;" aria-label="Default select example">
                    ...
                    <!--<option value="/hikma/users/teacher">Teacher</option>-->
                    {{-- <option  >Student</option> --}}
                    <!--<option value="/hikma/users/">All Records</option>-->
                </select>
            </div>
        ...
        <div class="card-body">
            <div class=" text-left">
                <a href="{{ url('users/usersDump') }}" class="btn btn-success ml-2">Excel Download</a>
            </div>
