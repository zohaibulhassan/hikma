...
@section('body')
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-top-cs {{config('adminlte.classes_topnav_nav', 'navbar-expand-md')}} {{config('adminlte.classes_topnav', 'navbar-white navbar-light')}}">
        ...
        <footer class="main-footer">
            <strong>Copyright © {{ date("Y") }} <a href="https://rholab.net/">Rholab</a>.</strong>
            All rights reserved.
